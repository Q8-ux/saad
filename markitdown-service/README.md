...
## الربط الشامل داخل GitHub

المستودع يحتوي أيضاً على GitHub Action مشتركة تعمل من دون نشر API:

- تحوّل PDF وWord وPowerPoint وExcel والبريد أينما وُضعت داخل المشروع.
- تحوّل النصوص والصور داخل مجلدات `docs` و`documents` و`source-documents`.
- تحفظ الناتج كـ GitHub Actions artifact لمدة 7 أيام ولا تضيف ملفات مولدة إلى
  فروع المشروع.
- تعمل تلقائياً مع أي مجلد مشروع جديد يضاف إلى `Q8-ux/saad`.

لأي مستودع GitHub مستقل جديد، انسخ
[`templates/caller-workflow.yml`](templates/caller-workflow.yml) إلى المسار
`.github/workflows/markitdown.yml` في ذلك المستودع. يستدعي القالب سير العمل
المشترك من هذا المستودع، لذلك تبقى نسخة المحرك وإعدادات الحماية مركزية.
