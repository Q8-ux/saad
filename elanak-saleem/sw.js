const CACHE='elanak-saleem-v2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./favicon.svg','./fonts/AL-Mohanad.ttf','./fonts/AL-Mohanad-Bold.ttf','./fonts/AL-Mohanad-Extra-Bold.ttf'];
