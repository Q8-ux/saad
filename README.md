# رَتِّل القرآن — النسخة 10

هذه حزمة المصدر الكاملة لنسخة GitHub Pages التي تضيف تفسير السعدي داخل المصحف، إلى جانب البحث الشامل بالكلمة والتعرّف على تسجيل التسميع والانتقال المباشر إلى المصحف والتلاوة، وست لغات.

- الموقع الحي على GitHub Pages: https://q8-ux.github.io/saad/rattil/
- ملف المصدر المضغوط: `rattil/source/rattil-source-v11.tar.gz`
- SHA-256: `2df637df9203142c9f65c17ad120bad8720e68c99fe2cac3f21cfdd4a8817c59`
