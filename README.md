# رَتِّل القرآن — النسخة 9

هذه حزمة المصدر الكاملة لنسخة GitHub Pages التي تضيف البحث الشامل بالكلمة في جميع آيات القرآن، إلى جانب التعرّف على تسجيل التسميع والانتقال المباشر إلى المصحف والتلاوة، وست لغات.

- الموقع الحي على GitHub Pages: https://q8-ux.github.io/saad/rattil/
- ملف المصدر المضغوط: `rattil/source/rattil-source-v9.tar.gz`
- SHA-256: `e712816f186ae8430ac684e4ba9de471902f72f5549f1d506fedbc5cd6264921`
