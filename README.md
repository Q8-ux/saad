# رَتِّل القرآن — النسخة 8

هذه حزمة المصدر الكاملة لنسخة GitHub Pages التي تضيف التعرّف على تسجيل التسميع، ومطابقة الآيات، والانتقال المباشر من النتيجة إلى المصحف والتلاوة، وست لغات.

- الموقع الحي على GitHub Pages: https://q8-ux.github.io/saad/rattil/
- ملف المصدر المضغوط: `rattil/source/rattil-source-v8.tar.gz`
- SHA-256: `0d6d8ec7a9bfc8d5270d9995961de0aeb27e01b48addd9d51fbfe0437557e611`
