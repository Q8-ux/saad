...
function setCategory(value){category=value;const sel=document.getElementById('suppliesCategory');if(sel)sel.value=value;document.querySelectorAll('[data-category]').forEach(b=>b.classList.toggle('active',b.dataset.category===value));renderProducts()}
