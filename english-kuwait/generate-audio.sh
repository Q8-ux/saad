...
make_audio(){
  local name="$1"; shift
  local text="$*"
  espeak -v en-us -s 145 -w "$OUT/$name.wav" "$text"
}
...
make_audio 7-3-listen "When you use the internet, you must protect your password and you must not share private information with strangers."
